...
def Interactive_Graph(BotName,df,i,j):
    print('Interactive Graph for Phase 2 for {} on {} at {}'.format(BotName,i,j))
    df = pd.read_csv(
        'C:/Users/bryan/AppData/Roaming/MetaQuotes/Terminal/6C3C6A11D1C3791DD4DBF45421BF8028/reports/{}/{}/{}/OptiResults-{}-{}-{}-Phase2.csv'.format(
            BotName, i, j, BotName, i, j))
    ...
    def create_figure():
        print('this is Create Figure on Bokeh Interactive for a single chart on unfiltered Phase 2')
    ...
    #show(layout)
    output_notebook()
    curdoc().title = "Phase 2 for {} on {} at {}".format(BotName,i,j),
    process = subprocess.call('bokeh serve --show BokehINTERACTIVE2.py')
