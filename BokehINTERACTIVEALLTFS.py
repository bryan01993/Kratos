...
dfp1 = pd.read_csv(
    'C:/Users/bryan/AppData/Roaming/MetaQuotes/Terminal/6C3C6A11D1C3791DD4DBF45421BF8028/reports/{}/{}/{}/OptiResults-{}-{}-{}-Phase1.csv'.format(
        BotName, Par, M5, BotName, Par, M5))
# Execution
def Interactive_Graph():
    print('Interactive Graph for Phase 1 for {} on {} at All Timeframes'.format(BotName,Par))
    dfp1 = pd.read_csv(
        'C:/Users/bryan/AppData/Roaming/MetaQuotes/Terminal/6C3C6A11D1C3791DD4DBF45421BF8028/reports/{}/{}/{}/OptiResults-{}-{}-{}-Phase1.csv'.format(
            BotName, Par, M5, BotName, Par, M5))
    dfp2 = pd.read_csv(
        'C:/Users/bryan/AppData/Roaming/MetaQuotes/Terminal/6C3C6A11D1C3791DD4DBF45421BF8028/reports/{}/{}/{}/OptiResults-{}-{}-{}-Phase1.csv'.format(
            BotName, Par, M15, BotName, Par, M15))

    dfp3 = pd.read_csv(
        'C:/Users/bryan/AppData/Roaming/MetaQuotes/Terminal/6C3C6A11D1C3791DD4DBF45421BF8028/reports/{}/{}/{}/OptiResults-{}-{}-{}-Phase1.csv'.format(
            BotName, Par, M30, BotName, Par, M30))

    dfp4 = pd.read_csv(
        'C:/Users/bryan/AppData/Roaming/MetaQuotes/Terminal/6C3C6A11D1C3791DD4DBF45421BF8028/reports/{}/{}/{}/OptiResults-{}-{}-{}-Phase1.csv'.format(
            BotName, Par, H1, BotName, Par, H1))

    dfp5 = pd.read_csv(
        'C:/Users/bryan/AppData/Roaming/MetaQuotes/Terminal/6C3C6A11D1C3791DD4DBF45421BF8028/reports/{}/{}/{}/OptiResults-{}-{}-{}-Phase1.csv'.format(
            BotName, Par, H4, BotName, Par, H4))
    ...
    def create_figure1():
        ...
        kwp1['title'] = "%s vs %s" % (x_titlep1, y_titlep1) + " for {} on {} and {}".format(BotName, Par, M5)
    ...
    def create_figure2():
        ...
        kwp2['title'] = "%s vs %s" % (x_titlep2, y_titlep2) + " for {} on {} and {}".format(BotName, Par, M15)
        ...
        # COLOR BAR NEXT TO GRAPHIC
        #PAIR 2
        Var_color_mapper = LinearColorMapper(palette="Inferno256", low=min(dfp2['Profit']), high=max(dfp2['Profit']))  # arreglar Maximo y minimo para que agarren el valor
        # Var_color_mapper = LinearColorMapper(palette="Inferno256",low=min(dfp1[color.value]),high=max(dfp1[color.value]))  # arreglar Maximo y minimo para que agarren el valor
        GraphTicker = AdaptiveTicker(base=50, desired_num_ticks=10, num_minor_ticks=20, max_interval=1000)
        Color_legend = ColorBar(color_mapper=Var_color_mapper, ticker=GraphTicker, label_standoff=12,border_line_color=None,location=(0, 0))  # arreglar LogTicker para que muestre por al escala del color
    ...
    def create_figure3():
        ...
        kwp3['title'] = "%s vs %s" % (x_titlep3, y_titlep3) + " for {} on {} and {}".format(BotName, Par, M30)
        ...
        # COLOR BAR NEXT TO GRAPHIC
        #PAIR 3
        Var_color_mapper = LinearColorMapper(palette="Inferno256", low=min(dfp3['Profit']), high=max(dfp3['Profit']))  # arreglar Maximo y minimo para que agarren el valor
        # Var_color_mapper = LinearColorMapper(palette="Inferno256",low=min(dfp1[color.value]),high=max(dfp1[color.value]))  # arreglar Maximo y minimo para que agarren el valor
        GraphTicker = AdaptiveTicker(base=50, desired_num_ticks=10, num_minor_ticks=20, max_interval=1000)
    ...
    def create_figure4():
        ...
        kwp4['title'] = "%s vs %s" % (x_titlep4, y_titlep4) + " for {} on {} and {}".format(BotName, Par, H1)
        ...
        # COLOR BAR NEXT TO GRAPHIC
        #PAIR 3
        Var_color_mapper = LinearColorMapper(palette="Inferno256", low=min(dfp4['Profit']), high=max(dfp4['Profit']))  # arreglar Maximo y minimo para que agarren el valor
        # Var_color_mapper = LinearColorMapper(palette="Inferno256",low=min(dfp1[color.value]),high=max(dfp1[color.value]))  # arreglar Maximo y minimo para que agarren el valor
        GraphTicker = AdaptiveTicker(base=50, desired_num_ticks=10, num_minor_ticks=20, max_interval=1000)
        Color_legend = ColorBar(color_mapper=Var_color_mapper, ticker=GraphTicker, label_standoff=12,border_line_color=None,location=(0, 0))
    ...
    def create_figure5():
        ...
        kwp5['title'] = "%s vs %s" % (x_titlep5, y_titlep5) + " for {} on {} and {}".format(BotName, Par, H4)
        ...
        # COLOR BAR NEXT TO GRAPHIC
        #PAIR 3
        Var_color_mapper = LinearColorMapper(palette="Inferno256", low=min(dfp5['Profit']), high=max(dfp5['Profit']))  # arreglar Maximo y minimo para que agarren el valor
        # Var_color_mapper = LinearColorMapper(palette="Inferno256",low=min(dfp1[color.value]),high=max(dfp1[color.value]))  # arreglar Maximo y minimo para que agarren el valor
        GraphTicker = AdaptiveTicker(base=50, desired_num_ticks=10, num_minor_ticks=20, max_interval=1000)
        Color_legend = ColorBar(color_mapper=Var_color_mapper, ticker=GraphTicker, label_standoff=12,border_line_color=None,location=(0, 0))
    ...
    output_notebook()
    curdoc().title = "Phase 1 on {} at All Timeframes".format(Par),

    process = subprocess.call('bokeh serve --show BokehINTERACTIVEALLTFS.py')
Interactive_Graph()
